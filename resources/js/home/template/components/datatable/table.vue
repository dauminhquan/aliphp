<template>
    <div class="panel panel-flat">
        ...
        <table id="data-table-1" class="table datatable-basic">
            <thead>
            <tr>
                <th>
                    <div class="btn-group navbar-btn" style="margin-left: unset !important;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="javascript:void(0);" @click="deleteSelected">Thêm vào Excel</a></li>
                        </ul>
                    </div>
                </th>
    ...
    export default {
        ...
        methods: {
            Init()
            {
                ...
                vm.table = $('#data-table-1').dataTable({
                ...
                $('button.dt-button.buttons-collection.buttons-colvis.btn.bg-blue.btn-icon[tabindex="0"][aria-controls="data-table-1"]').click(function () {
