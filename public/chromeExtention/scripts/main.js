                        ...
                        $.ajax({
                            ...
                            success: function success(data) {
                                if (data.result == 1) {
                                    ...
                                    var price = ((parseFloat(highPrice) + parseFloat(data.priceShip)) * 2).toFixed(2);
                                    ...
                                    for (var _i6 = 0; _i6 < 5; _i6++) {
                                        if ($(specificsLis).text() == undefined) {
                                            dtPost['bullet_point' + (_i6 + 1)] = '';
                                        } else {
                                            dtPost['bullet_point' + (_i6 + 1)] = specificsLis[_i6].innerText;
                                        }
                                    }
                                    var other_images_array = other_images.split(';');
                                    for (var _i7 = 0; _i7 < 3; _i7++) {
                                        if (other_images_array[_i7] == undefined) {
                                            if (_i7 == 0) {
                                                dtPost['other_image_url'] = null;
                                            }
                                            dtPost['other_image_url' + (_i7 + 1)] = null;
                                        } else {
                                            if (_i7 == 0) {
                                                dtPost['other_image_url'] = other_images_array[_i7];
                                            }
                                            dtPost['other_image_url' + (_i7 + 1)] = other_images_array[_i7];
                                        }
                                    }
